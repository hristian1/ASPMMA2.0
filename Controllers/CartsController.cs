...
namespace ASPMMA.Controllers
{
    public class CartsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductId,Quantity,ApplicationUserId,CreatedAt")] Cart cart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProductId,Quantity,ApplicationUserId,CreatedAt")] Cart cart)
        {
            if (id != cart.Id)
            {
                return NotFound();
